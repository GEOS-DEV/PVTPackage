...
namespace PVTPackage
{
	...
	{
		PhaseProperties(std::size_t ncomponents) : MolecularWeight(ncomponents), CompressibilityFactor(ncomponents), MoleComposition(ncomponents,ncomponents), LnFugacityCoefficients(ncomponents, ncomponents),
