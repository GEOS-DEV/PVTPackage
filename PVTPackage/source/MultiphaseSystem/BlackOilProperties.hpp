...
namespace PVTPackage
{
	...
	{
		BlackOilProperties(size_t n_components, std::vector<std::string> labels, std::vector<double> mw, std::vector<double> tc,
		...
		double SurfaceOilDensity;
		double SurfaceWaterDensity;
		double SurfaceGasDensity;
