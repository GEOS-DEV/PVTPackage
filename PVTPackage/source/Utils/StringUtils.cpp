...
bool StringUtils::RemoveStringAndFollowingContentFromLine( std::string ToBeRemoved,
                                                           std::string & line )
{
...
std::string StringUtils::RemoveString( std::string ToBeRemoved,
                                       std::string data )
{
...
bool StringUtils::ExtendDefault( int n,
                                 std::string & v )
{
...
std::string StringUtils::GetNthWord( int n,
                                     std::string data )
{
